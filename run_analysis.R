...
totaldata_extract<-totaldata[,grepl(".*description.*|.*activity.*|.*subject.*|.*mean.*|.*std.*",names(totaldata))]


### 4.Create Summary and tidy.txt 
totaldata_melt<-melt(totaldata_extract, id.vars = c("subject", "activity","description"))
